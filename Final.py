# MBA Strategic Analysis - 3 Executive-Level Graphs
# Optimized Scaling for Clear Trend Visualization
...
def load_and_prepare_data():
    ...
    # Load datasets with exact file names
...
def create_interactive_dashboard(df):
    ...
    fig.add_annotation(
        ...
        xref="paper",
        yref="paper",
        text="Copyright Younus Choudhury 2025",
        showarrow=False,
